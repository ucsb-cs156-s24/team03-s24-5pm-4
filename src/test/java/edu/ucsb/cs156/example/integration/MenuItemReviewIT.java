...
public class MenuItemReviewIT {
        ...
        public void test_that_logged_in_user_can_get_by_id_when_the_id_exists() throws Exception {
                ...
                MenuItemReview review = MenuItemReview.builder()
                                .itemId(1L)
                                .reviewerEmail("ssiva@ucsb.edu")
                                .stars(5)
                                .dateReviewed(LocalDateTime.parse("2022-01-01T00:00:00"))
                                .comments("Tasty")
                                .build();
        ...
        public void an_admin_user_can_post_a_new_menu_item_review() throws Exception {
                ...
                MvcResult response = mockMvc.perform(
                                post("/api/menuitemreview/post?itemId=1&reviewerEmail=ssiva@ucsb.edu&stars=5&dateReviewed=2022-01-01T00:00:00&comments=Tasty")
                                                .with(csrf()))
                                .andExpect(status().isOk()).andReturn();
