...
* Prod: <https://team03.dokku-12.cs.ucsb.edu>
...
|---------------------------|---------------|---------------|
| UCSBDiningCommonsMenuItem |   Tony Tran   |   GuBinhti    |
| UCSBOrganization          |   Simon Mann  |  Simonmann17  |
| RecommendationRequest     | Daniel Jenson |   Division7   |
| MenuItemReview            |Sreeganesh Siva|    SR33G33    |
| HelpRequest               |Jason Rodrigues|jason-rodrigues|
| Articles                  |Elijah Anderson|ElijahCanderson|
