...
describe("UCSBOrganizationIndexPage tests", () => {
    ...
    test("renders three dates correctly for regular user", async () => {
        ...
        expect(screen.getByTestId(`${testId}-cell-row-2-col-orgCode`)).toHaveTextContent("SIGEP");
    ...
    test("what happens when you click delete, admin", async () => {
        ...
        const queryClient = new QueryClient();
        axiosMock.onGet("/api/ucsborganizations/all").reply(200, ucsbOrganizationFixtures.threeOrganizations);
        axiosMock.onDelete("/api/ucsborganizations").reply(200, "UCSBOrganization with id KRC was deleted");
