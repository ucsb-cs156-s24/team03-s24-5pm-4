...
describe("UserTable tests", () => {
  ...
  test("Delete button calls deleteCallback", async () => {
    ...
    const deleteButton = screen.getByTestId(`HelpRequestTable-cell-row-0-col-Edit-button`);
    expect(deleteButton).toBeInTheDocument();
    
    fireEvent.click(deleteButton);

    await waitFor(() => expect(mockedNavigate).toHaveBeenCalledWith('/helprequest/delete/1'));
