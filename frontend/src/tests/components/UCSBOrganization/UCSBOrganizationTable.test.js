...
describe("UCSBOrganizationTable tests", () => {
  ...
  test("Has the expected column headers, content and buttons for admin user", () => {
    ...
    expect(screen.getByTestId(`${testId}-cell-row-0-col-orgTranslationShort`)).toHaveTextContent("KOREAN RADIO CLUB");
  ...
  test("Edit button navigates to the edit page", async () => {
    ...
    await waitFor(() => expect(mockedNavigate).toHaveBeenCalledWith('/ucsborganizations/edit/KRC'));
